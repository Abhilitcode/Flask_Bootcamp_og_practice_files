...
print(x1.name)#instance attribute are inside init function
print(x2.name)#so they can have different values for each objects
print(x1.species)#both objects will have same class attribute
print(x2.species)
