...
# The decorator is taking another function as an argument,
# and returning a new function which executes the given function func when it is run.
    print(func())
...
def new_decorator(func):
    ...
    def wrap_func():
        print("Hello")
        print("task performed before function")
        func()
        print("task performed after the function")
    return wrap_func

#new_func_decorate = new_decorator(new_func_decorate) or @new_decorator in one line
@new_decorator
def new_func_decorate():
    print("Hello Ram Ram")
